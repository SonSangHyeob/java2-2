...
이벤트 기반 프로그래밍  
    ...
    이벤트 종류  
        ...
        센서로부터의 입력 네트워크로부터 테이터 송수신  
        다른 으용프로그램이나 다른 스레드로부터의 메시지  
이벤트 기반 응용 프로그램의 구조
    각 이벤트마다 처리하는 리스너 코드 보유  
GUI 으용프로그램은 이벤트 기반 프로그래밍으로 작성됨  
    GUI 라이브러리 종류  
        C++의 MFC, C# GUI, VB, X Window, Android 등  
        자바의 AWT와 Swing  
